      ...
      >
        ...
        <div class="help-dialog__body">
          <p class="help-dialog__intro">
            Aquí tienes lo esencial para moverte por Stock F1.
          </p>
          <div class="help-topics">
            <article class="help-topic">
              ...
              <div>
                ...
                <p>
                  Explora los regalos disponibles y revisa el stock antes de
                  hacer una solicitud.
                </p>
              </div>
            </article>
            <article class="help-topic">
              ...
              <div>
                ...
                <p>
                  Selecciona un producto, indica la cantidad y envía la
                  solicitud con tu correo corporativo.
                </p>
              </div>
            </article>
            <article class="help-topic">
              ...
              <div>
                ...
                <p>
                  Gestiona las solicitudes pendientes y actualiza las unidades
          ...
          <div class="help-contact">
            ...
            <p>
              <strong>¿Algo no funciona?</strong
              ><span>Contacta con Operations para recibir asistencia.</span>
            </p>
          </div>
        </div>
      </section>
